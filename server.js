...
// Servir el configurador HTML
app.get('/', (req, res) => {
  const configPath = path.join(__dirname, '..', 'CONFIGURADOR - 20 ABRIL Cuatro Pájaros Atelier.html');
  console.log('📄 Sirviendo configurador desde:', configPath);
  ...
  if (fs.existsSync(configPath)) {
    ...
    res.status(404).send('Configurador no encontrado');
  }
});
