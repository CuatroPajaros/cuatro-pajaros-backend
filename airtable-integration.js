...
async function crearPedidoEnAirtable() {
  try {
    ...
    const record = {
      fields: {
        'Nombre Cliente': pedido.nombre,
        'Email': pedido.email,
        'Teléfono': pedido.telefono,
        'Dirección': pedido.direccion,
        'Localidad': pedido.localidad,
        'Notas': pedido.notas || '',
        'Accesorios': pedido.accesorios,
        'Monto Total': pedido.monto,
        'Estado': 'Pedido Solicitado',
        'Timestamp Pedido': new Date().toISOString()
      }
    };
    ...
    // Mostrar modal con instrucciones de pago
...
/**
 * Recolectar datos del formulario del pedido
 */
    ...
    ">
      ...
      ">
        ...
        ">
          ...
          <button onclick="copyToClipboard('CUATROPAJAROS@ICLOUD.COM')" style="
            background: #4CAF50;
            color: white;
            border: none;
            padding: 6px 12px;
      ...
      <p style="margin: 15px 0; color: #666; font-size: 14px;">
        Una vez realices la transferencia, haz clic en "Confirmar Pago Realizado"
      </p>

      <div style="margin-top: 20px; display: flex; gap: 10px;">
        <button onclick="confirmarPagoEnAirtable()" style="
          flex: 1;
          background: #4CAF50;
          color: white;
          border: none;
          ...
          font-weight: bold;
          cursor: pointer;
        ">✓ Confirmar Pago Realizado</button>
  ...
  modal.innerHTML = `
    ...
    ">
      ...
      <p style="
        ...
        line-height: 1.6;
      ">
        Tu pago ha sido registrado correctamente. En breve recibirás un email de confirmación con los detalles de tu pedido y el estado de entrega.
      </p>

      <p style="margin: 15px 0; color: #999; font-size: 14px;">
        Gracias por tu compra en Cuatro Pájaros ✨
      </p>

      <button onclick="cerrarYLimpiar()" style="
        background: #4CAF50;
        color: white;
        border: none;
        padding: 12px 30px;
